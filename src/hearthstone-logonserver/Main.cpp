...
#define BANNER "WowEmu r%u/%s-%s (%s) :: Logon Server\n"
...
{
#ifdef WIN32
	char * config_file = "configs/wowemu-logonserver.conf";
#else
	char * config_file = (char*)CONFDIR "configs/wowemu-logonserver.conf";
#endif
